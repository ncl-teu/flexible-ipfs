...
public class Config {
    ...
    public static Config build(String contents) {
        ...
        IdentitySection identitySection = null;
        if(json.get("Identity") == null){
            return new Config();
        }else{
            identitySection = Jsonable.parse(json, p -> IdentitySection.fromJson(p));
    ...
    public Config defaultConfig() {
        ...
        List<MultiAddress> bootstrapNodes = List.of(
                      ...
                      //  "/dnsaddr/bootstrap.libp2p.io/p2p/QmbLHAnMoJPWSCR5Z:q!htx6BHJX9KiKNN6tpvbUcqanj75Nb",
                      //  "/dnsaddr/bootstrap.libp2p.io/p2p/QmcZf59bWwK5XFi76CZX8cbJ4BhTzzA3gU1ZjYZcYW3dwt",
                      //  "/ip4/104.131.131.82/tcp/4001/p2p/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ", // mars.i.ipfs.io
                        Kad.GW_ENDPOINT).stream()
